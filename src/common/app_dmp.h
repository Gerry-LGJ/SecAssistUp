...
#else
    QMessageBox::critical(nullptr, "Error", QString("We apologize for the inconvenience caused by an unexpected error. \nDump: %1").arg(dumpFileName), QMessageBox::Ok, QMessageBox::Ok);\
